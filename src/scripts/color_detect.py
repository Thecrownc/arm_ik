...
class ColorDetector:
    def __init__(self):
        ...
        self.image_pub = rospy.Publisher('/camera_f/color/image_detected', Image, queue_size=10)
    ...
    def image_callback(self, data):
        try:
            ...
            # 检测颜色块
            result_strings,result_image= detect_color_blocks(cv_image, self.frame_count)
            
            # 发布检测结果
            if result_strings:
                result_msg = String()
                result_msg.data = json.dumps(result_strings)
